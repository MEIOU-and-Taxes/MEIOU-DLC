...
static const float  LIGHT_INTENSITY   			= 1.6f;  //4.0
...
static const float  MAP_LIGHT_INTENSITY   		= 1.5f;  //4.0
...
static const float 	WATER_TILE					= 0.125f;  //1.0
static const float 	WATER_TIME_SCALE			= 10.0f;  //12.0
